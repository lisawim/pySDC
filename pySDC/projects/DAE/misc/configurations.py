from pySDC.implementations.hooks.log_errors import LogGlobalErrorPostIter, LogGlobalErrorPostSweep, LogGlobalErrorPostStep
...
def get_configs(problem_name: str, config_type: str) -> dict:
    ...
    if config_type == "work_precision":
        ...
        if problem_name == "REACTION-DIFFUSION":
            config["QI_serial_methods"] = ["IE", "LU", "RadauIIA5", "RadauIIA7"]
