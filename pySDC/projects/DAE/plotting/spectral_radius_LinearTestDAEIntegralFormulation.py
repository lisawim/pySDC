...
def plot():
    ...
    Path(f"data/LinearTestDAEIntegralFormulation").mkdir(parents=True, exist_ok=True)
    ...
    fig.savefig(f"data/LinearTestDAEIntegralFormulation/SR_IterMatrix_QI={QI}_M={M}_{quad_type}.png", dpi=300, bbox_inches='tight')
    plt.close(fig)
