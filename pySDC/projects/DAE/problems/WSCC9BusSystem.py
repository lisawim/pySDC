...
class WSCC9BusSystem(ptype_dae):
    ...
    def eval_f(self, u, du, t):
        ...
        dw, dEfd, dRF = du.diff[5 * self.m : 6 * self.m], du.diff[6 * self.m : 7 * self.m], du.diff[7 * self.m : 8 * self.m]
        dVR, dTM, dPSV = du.diff[8 * self.m : 9 * self.m], du.diff[9 * self.m : 10 * self.m], du.diff[10 * self.m : 11 * self.m]
        ...
        VR, TM, PSV = u.diff[8 * self.m : 9 * self.m], u.diff[9 * self.m : 10 * self.m], u.diff[10 * self.m : 11 * self.m]
