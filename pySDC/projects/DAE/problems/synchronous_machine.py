...
class synchronous_machine_infinite_bus(ptype_dae):
    ...
    def __init__(self, nvars=(8, 6), newton_tol=1e-8):
    ...
    def eval_f(self, u, du, t):
        ...
        delta_r = u.diff[6] #u[12]
        omega_m = u.diff[7] # u[13]

        # differential components
        # these result directly from the voltage equations, introduced e.g. pg. 145 Krause
        dpsi_d, dpsi_q, dpsi_F, dpsi_D, dpsi_Q1, dpsi_Q2 = du.diff[0], du.diff[1], du.diff[2], du.diff[3], du.diff[4], du.diff[5]
        ddelta_r = du.diff[6]
        domega_m = du.diff[7]
        # Network current
