...
class one_transistor_amplifier(ptype_dae):
    ...
    def eval_f(self, u, du, t):
        ...
        f.diff[:] = (
            ...
            (u_b - u.diff[1]) / r_k - u.diff[1] / r_k + c_1 * (du.diff[0] - du.diff[1]) - (1 - alpha) * _transistor(u.diff[1] - u.diff[2]),
...
class two_transistor_amplifier(ptype_dae):
    ...
    def eval_f(self, u, du, t):
        ...
        f.diff[:] = (
            ...
            (u_b - u.diff[1]) / r_k - u.diff[1] / r_k + c_1 * (du.diff[0] - du.diff[1]) + (alpha - 1) * _transistor(u.diff[1] - u.diff[2]),
            _transistor(u.diff[1] - u.diff[2]) - u.diff[2] / r_k - c_2 * du.diff[2],
            (u_b - u.diff[3]) / r_k - c_3 * (du.diff[3] - du.diff[4]) - alpha * _transistor(u.diff[1] - u.diff[2]),
            (u_b - u.diff[4]) / r_k - u.diff[4] / r_k + c_3 * (du.diff[3] - du.diff[4]) + (alpha - 1) * _transistor(u.diff[4] - u.diff[5]),
