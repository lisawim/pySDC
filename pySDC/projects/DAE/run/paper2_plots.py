...
def make_scaling_plots(global_comm, journal="SIAM_Scientific_Computing"):
    ...
    filename = "results_scaling_dt=0.05_reaction_diffusion.pkl"
    plots_scaling(
...
def make_speedup_at_accuracy_plots(global_comm, journal="SIAM_Scientific_Computing"):
    ...
    filename = "results_speedup_at_acc_dt=0.05_linear.pkl"
    ...
    filename = "results_speedup_at_acc_dt=0.05_reaction_diffusion.pkl"
    plots_speedup_at_accuracy(
