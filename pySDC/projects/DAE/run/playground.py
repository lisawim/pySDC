...
from pySDC.projects.DAE.problems.TestDAEs import LinearTestDAEIntegralFormulation
...
def run():
    ...
    description = {
        'problem_class': LinearTestDAEIntegralFormulation,
...
def plotSolution(stats):
    ...
    plt.savefig('data/EmbeddedLinearTestDAE/solution.png', dpi=300, bbox_inches='tight')
    plt.close()
