...
def plot_manifold_val_and_error_vs_iteration(
    ...
    hook_class = [LogGlobalErrorDiffVar, LogGlobalErrorAlgVar, LogAbsValueAlgConstraints]
    ...
    for q, QI in enumerate(QI_list):
        ...
        for sweeper_type in sweeper_types:
            ...
            x = [me[0] for me in get_sorted(solution_stats, type="g_abs_post_iteration", sortby="iter")]
            g_abs_values = [me[1] for me in get_sorted(solution_stats, type="g_abs_post_iteration", sortby="iter")]
            err_diff_values = [
...
def plot_manifold_value_vs_iteration(
    ...
    hook_class = [LogAbsValueAlgConstraints]
    ...
    for q, QI in enumerate(QI_list):
        for sweeper_type in sweeper_types:
            ...
            ax.semilogy(
                ...
                markersize=2.9,
                markeredgewidth=0.4,
                alpha=1.0 if sweeper_type == "semiImplicitDAE" else 0.4,
                label=label,
            )
    ...
    plot_name = "alg_const_vs_iterations_highlight_si_sdc.png"#"Fig13.png"
    filename = "data" + "/" + f"{problem_name}" + "/" + plot_name
    file_path = Path(filename)
    file_path.parent.mkdir(parents=True, exist_ok=True)
...
if __name__ == "__main__":
    ...
    plot_manifold_value_vs_iteration(dt=dt, num_nodes=6, problem_name="REACTION-DIFFUSION")
