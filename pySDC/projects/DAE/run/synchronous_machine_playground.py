...
def main():
    ...
    uend_ref = DAEMesh(P.init)
    uend_ref.diff[:8] = (8.30823565e-01,
        -4.02584174e-01,
        1.16966755e00,
        9.47592808e-01,
        -3.68076863e-01,
    ...
    errDiff = np.linalg.norm(uend.diff - uend_ref.diff, np.inf)
    print(errDiff)
    assert np.isclose(errDiff, 0, atol=1e-4), "Error too large."
